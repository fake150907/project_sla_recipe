...
import com.sla.project.repository.ReactionPointRepository;
...
public class ReactionPointService {
	...
	public ResultData addGoodReactionPoint(int loginedMemberId, String relTypeCode, int relId) {
		...
		switch (relTypeCode) {
		case "recipe":
			recipeService.increaseGoodReactionPoint(relId);
			break;
		}
	...
	public ResultData addBadReactionPoint(int loginedMemberId, String relTypeCode, int relId) {
		...
		switch (relTypeCode) {
		case "recipe":
			recipeService.increaseBadReactionPoint(relId);
			break;
		}
	...
	public ResultData deleteGoodReactionPoint(int loginedMemberId, String relTypeCode, int relId) {
		...
		switch (relTypeCode) {
		case "recipe":
			recipeService.decreaseGoodReactionPoint(relId);
			break;
		}
	...
	public ResultData deleteBadReactionPoint(int loginedMemberId, String relTypeCode, int relId) {
		...
		switch (relTypeCode) {
		case "recipe":
			recipeService.decreaseBadReactionPoint(relId);
			break;
		}
