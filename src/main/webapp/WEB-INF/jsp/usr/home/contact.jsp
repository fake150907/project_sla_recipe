            ...
            <table class="write-box table-box-1 mx-auto mt-10" border="1">
                <tbody>
                    <tr>
                        ...
                        <td><input class="input input-bordered input-md w-full max-w-xs" autocomplete="off" type="text"
                            placeholder="이름을 입력해주세요" name="name" />
                            <div style="display: inline-block; font-weight: 600; margin-left: 3.2em;">연락처</div> <input
                            class="input input-bordered input-md w-full max-w-xs" autocomplete="off" type="text"
                            placeholder="전화번호를 입력해주세요" name="contact"/></td>

                    </tr>

                    <tr>
                        <th style="font-weight: 600">이메일</th>
                        <td><input class="input input-bordered input-md w-full " autocomplete="off" type="text"
